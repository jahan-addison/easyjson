...
easyjson is a lightweight JSON library for modern C++. Due to its design, you're able to create and work with JSON objects right away, just as you would from a scripting language. easyjson is a single C++ header file, "easyjson.h".

easyjson requires at least **C++17**, and has been tested with clang-18 and gcc-10 on macOS (arm) and Ubuntu.
